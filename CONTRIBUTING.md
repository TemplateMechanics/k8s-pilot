...
3. **No GitHub Actions CI on this repo at this time.** Validation is local-only via `scripts/Pre-Commit.ps1` (planned, PR 11). If you believe a workflow is needed, open an issue first.
...
# 4. Run the local gate (planned, PR 11)
