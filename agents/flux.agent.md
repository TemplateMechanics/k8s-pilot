...
- `flux suspend kustomization X` halts reconciliation. Use it during incident response. **Always include `-Reason "<text>"` in `Invoke-FluxSuspend.ps1`** — the audit trail is the only way to remember why something was suspended.
